...
<head>
	...
	<link rel="stylesheet" href="//code.jquery.com/ui/1.13.1/themes/base/jquery-ui.css">
  	...
  	<link href="css/0option1.css" rel="stylesheet" type="text/css">
  	<script type="text/javascript" src="js/0option1.js?ver=1"></script>
  	<style>
  	*{
		margin: 0;
  	}
...
%>
	...
	<ul style="margin-bottom: 40px;">
		...
		<li class="li">
			<button class="h" id="logout1">로그아웃</button>
		</li>
		<li class="li_1">
