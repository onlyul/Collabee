...
<head>
	...
	<style>
		...
		.input_for_request_email:focus {
			outline: none;
			border-bottom-color: 1px solid #d9ad2b; 
		...
		.resetPW_btn_cert:hover{
			background-color: rgb(179, 142, 34);
    		border-color: rgb(179, 142, 34);
		}
		.resetPW_input_container{
			display: none;
		}
		#resetPW1{
			display: none;
		...
		.signUp_body_btn_iconcontainer>img{
			width: 31px;
    		height: 31px;
	    ...
	    /*  문서가 칸반으로 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
	    .section_intro_kanban{
	    	display: flex;
		    flex-direction: row;
		    text-align: center;
		    margin-top: 120px;
	    ...
	    .welcomeStyles_carouselBg_right{
	    	width: 100%;
		    background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/530/static/media/main_kanban_4.95157699.png);
	    ...
	    .welcomeStyles_carouselBg_left{
	    	width: 100%;
		    background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/530/static/media/main_kanban_2.e178cd20.png);
		    background-repeat: no-repeat;
		    background-size: 1140px;
	    ...
	    .icon{
		    ...
		    height: 28px;
		    margin-left: 8px;
		    border: 1px solid rgba(217, 173, 43, 0.5);
		    border-radius: 50%;
	    }
	    .icon>svg{
	    	position: absolute;
	    ...
	    .BrainhubCarousel_arrowLeft>button{
	    	text-align: center;
		    width: 40px;
		    height: 40px;
		    border-radius: 50%;
	    ...
	    .BrainhubCarousel_arrowLeft>button>svg{
	    	display: inline-block;
		    vertical-align: middle;
		    shape-rendering: inherit;
	    }
	    .BrainhubCarousel_arrowLeft>button>svg>path{
	    	fill: rgb(34, 34, 34);
	    } */
	    .BrainhubCarousel_trackContainer{
	    	width: 100%;
    		overflow: hidden;
	    }
	    .slider>div>img{
		...
		/* 문서가 칸반으로 밑으로 ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ */
		.section3{
			padding-top: 150px;
		...
		.section4_1{
			...
			position: relative;
			margin: 0 auto;
			background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/527/static/media/img_main_file.2916d42e.png);
			z-index: 0;
			background-repeat: no-repeat;
			text-align: center;
			margin-top: 20px;
		...
		.li_1::before{
			background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/icon-circle-check-primary.f6c2a8f0.png);
			display: inline-block;
		    width: 20px;
		    height: 20px;
		    margin-right: 8px;
		...
		#btn11:hover{
			background-color: rgb(179, 142, 34) !important;
		}
		#btn21:hover{
			background-color: rgb(42, 98, 81) !important;
		}
		li{
			color: rgb(34, 34, 34);
		    font-size: 18px;
		...
		.li_2::before{
			background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/icon-circle-check-secondary.e6cb2420.png);
			display: inline-block;
		    width: 20px;
		    height: 20px;
		    margin-right: 8px;
		...
		.f_btn1{
			cursor: pointer;
			padding: 10px;
			background: url(https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/btn-footer-language-arrow.8122679b.png) right center no-repeat;
			padding-right: 35px !important;
			border: none;
			font-weight: bold;
		}
		.clicked{
			background: url(https://cdn.collabee.co/front/collabee.co/hornet/530/static/media/btn-footer-language-arrow-hover.142d0a23.png) right center no-repeat;
		}
		.f_btn1:hover{
			color: rgb(171, 136, 32);
		}
		.language{
			display: none;
		    position: absolute;
		...
		.active{
			background: url(https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/ic-footer-language-check.96d4f2d6.png) right center no-repeat;
		}
		.l_detail:hover{
			color: #bababa;
		}
		...
		.section8{
			background: url(https://cdn.collabee.co/front/collabee.co/hornet/543/static/media/bg-freetrial.8e4e0488.png) center center / cover no-repeat rgb(0, 89, 73);
		    height: 340px;
		    box-sizing: border-box;
		    display: flex;
		    flex-direction: column;
	    ...
	    .section_intro_01_signUp_container{
	    	margin-top: 40px;
	    }
	    .emailForm{
	    	display: flex;
	    ...
	    .section_intro_01_social_login_btn{
	    	width: 253px;
		    height: 40px;
		    border: 1px solid rgb(204, 204, 204);
		    border-radius: 6px;
	    ...
	    .section_intro_01_social_login_btn div{
	    	height: 24px;
		    line-height: 1.63;
		    font-size: 16px;
		    margin-left: 6px;
	    }
	    .section_intro_01_social_login_btn:hover{	    
		    background-color: rgb(247, 246, 245);
	    }
	    .section_intro_01_goLogin{
	    	margin-top: 12px;
		    font-size: 15px;
		    line-height: 1.6;
	    }
	    .section_intro_01_goLogin>span{
			color: rgb(34, 34, 34);
		    display: inline-block;
		    padding-right: 7px;
	    }
	    .section_intro_01_goLogin_btn{
	    	background-color: transparent;
		    color: rgb(217, 173, 43);
		    font-size: inherit;
		    line-height: inherit;
 	    ...
 	    .section_intro_01_signUp_btn:hover{
 	    	background-color: rgb(189, 148, 26);
 	    }
 	    .section_intro_01_img{
 	    	position: absolute;
		    right: 0px;
		    content: "";
		    width: 560px;
		    height: 480px;
		    background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/543/static/media/img_main_illust.1e9f59c5.png);
		    background-repeat: no-repeat;
	...
	.section_intro2{
		background: linear-gradient(to left, rgb(247, 247, 245), rgb(247, 247, 245)) 0px 313px no-repeat;
	...
	.kKpncP {
	    position: relative;
	    background-image: url(https://cdn.collabee.co/front/collabee.co/hornet/543/static/media/img_main_con1_bg.1cec4ce8.png);
							...
							<div class="login_other">
								<button class="login_other_button login_other_btn_naver">
									<div class="signUp_body_btn_iconcontainer" style="margin-right: 80px; margin-bottom: -3px;">
			   							<img src="images/btnW_아이콘사각.png" style="border-radius: 0px;"/>
			   						</div>
			   						<div>Naver</div>
								</button>
								<button class="login_other_button login_other_kakao">
									<img src="images/kakao_logo.jpg" style="margin-right:5px; width: 30px; height: 30px;"/>
									<div>Kakao</div>
								</button>
							</div>
					...
					<div class="signUp_body">
						...
						<button class="signUp_body_social_btn social_btn_kakao">
							<div class="signUp_body_btn_iconcontainer">
								<img src="images/kakao_logo.jpg" style="margin-top: 2px;"/>	
							</div>
							<div>KaKao로 가입하기</div>
						</button>
...
<a class="btn_detail" href="">
	...
	<div class="container1">
		...
		<div class="section6_1">
			<div class="section6_2" style="box-shadow: rgb(217 173 43 / 35%) 0px 5px 20px 0px;">
				...
				<button id="btn11" class="btn1" style="background-color: rgb(217, 173, 43);">무료로 시작하기</button>
			</div>
			<div class="section6_2" style="box-shadow: rgb(51 132 108 / 30%) 0px 5px 20px 0px;">
				...
				<button id="btn21" class="btn1" style="background-color: rgb(51, 132, 108);">도입 문의</button>
			</div>
		</div>
	</div>
	</div>
	...
	<div class="section7">
		...
		<a class="go" href="">자세히 보러가기</a>
		<ul class="ul1">
			<li class="li_3"><a class="section7_1" href=""><img class="img30" src="https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/img_main_con4_ic1.ca055904.png" width="92" alt="">서비스 개발</a></li>
			<li class="li_3"><a class="section7_1" href=""><img class="img30" src="https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/img_main_con4_ic2.711fff3a.png" width="92" alt="">제품 마케팅</a></li>
			<li class="li_3"><a class="section7_1" href=""><img class="img30" src="https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/img_main_con4_ic3.b6de0dcc.png" width="92" alt="">품질 관리</a></li>
			<li class="li_3"><a class="section7_1" href=""><img class="img30" src="https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/img_main_con4_ic4.80276a22.png" width="92" alt="">채용 및 인사관리</a></li>
			<li class="li_3"><a class="section7_1" href=""><img class="img30" src="https://cdn.collabee.co/front/collabee.co/hornet/528/static/media/img_main_con4_ic5.8801a6f8.png" width="92" alt="">회의 및 협업</a></li>
		</ul>
		</div>
	</div>
			...
			<div class="container10_1">
				<dl>
					...
					<span>콜라비</span>
						...
						<dd>
						<a class="dd" href="">메신저</a>
						</dd>
						<dd>
						<a class="dd" href="">가격</a>
						</dd>
						<dd>
				...
				<dl>
					...
					<dd>
						<a class="dd" href="">서비스 개발
						</a>
					</dd>
					<dd>
						<a class="dd" href="">제품 마케팅
						</a>
					</dd>
					<dd>
						<a class="dd" href="">품질 관리
						</a>
					</dd>
					<dd>
						<a class="dd" href="">채용 및 인사관리
						</a>
					</dd>
					<dd>
						<a class="dd" href="">회의 및 협업
						</a>
					</dd>
				</dl>
				<dl>
	...
	<div class="footer2">
		...
		<ul class="language">
			<li><a id="en"  data-type="en" class="l_detail">English</a></li>
			<li class="active"><a  data-type="ko" class="l_detail">한국어</a></li>
		</ul>
		<button class="f_btn2">
